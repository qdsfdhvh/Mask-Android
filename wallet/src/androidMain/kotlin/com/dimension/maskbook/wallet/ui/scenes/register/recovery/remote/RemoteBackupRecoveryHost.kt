...
@Composable
fun RemoteBackupRecoveryNoBackup(
    @Back onBack: () -> Unit,
) {
    MaskDialog(
...
@Composable
fun RemoteBackupRecoveryEmailCode(
...
@Composable
fun RemoteBackupRecoveryPhoneCode(
    navController: NavController,
